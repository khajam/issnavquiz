(ns issnavquiz.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [issnavquiz.routes.home :refer [home-routes]]
            [issnavquiz.middleware :as middleware]
            [issnavquiz.session :as session]
...
(defn init
  ...
  (timbre/info (str
                 "\n-=[issnavquiz started successfully"
...
(defn destroy
  ...
  []
  (timbre/info "issnavquiz is shutting down...")
  (stop-nrepl)
